...
public class RestaurateurUser extends User {
    ...
    public RestaurateurUser(long id, String email, String password, String name, String surname, LocalDate birthDate, String phoneNumber, String avatar, Role role, boolean active, String firebaseCustomToken, Restaurant restaurant) {
