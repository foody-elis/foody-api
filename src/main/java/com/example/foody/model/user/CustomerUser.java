...
public class CustomerUser extends User {
    ...
    public CustomerUser(long id, String email, String password, String name, String surname, LocalDate birthDate, String phoneNumber, String avatar, Role role, boolean active, String firebaseCustomToken, CreditCard creditCard, List<Review> reviews, List<Booking> bookings, List<Order> orders) {
