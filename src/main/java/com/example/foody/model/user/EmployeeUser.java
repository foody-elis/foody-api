...
public abstract class EmployeeUser extends User {
    ...
    public EmployeeUser(long id, String email, String password, String name, String surname, LocalDate birthDate, String phoneNumber, String avatar, Role role, boolean active, String firebaseCustomToken, Restaurant employerRestaurant) {
