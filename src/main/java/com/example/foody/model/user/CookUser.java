...
public class CookUser extends User {
    ...
    public CookUser(long id, String email, String password, String name, String surname, LocalDate birthDate, String phoneNumber, String avatar, Role role, boolean active, CreditCard creditCard, Restaurant employerRestaurant) {
